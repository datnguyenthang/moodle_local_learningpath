...
class utility {
    ...
    public static function generateCategoryStructure($categories)
    {
        ...
        $html .= '<div class="menu-wrapper">
                        <ul class="m-0 p-pl-5">
                            <li><a href="#" data-cat-id="0" data-category="All Categories" class="category-link ellipsis">'.get_string('allcourescattext', 'theme_remui').'</a></li>
                        </ul>
                  </div>';
        ...
        foreach ($categoryTree as $category) {
            ...
            if ($hasChildren) {
                $html .= '<div class="menu-heading d-flex flex-gap-2 w-100">
                            ...
                            <a href="#" data-cat-id="'.$category->id.'" data-category="'.$category->name.'" class="category-link ellipsis catvisibility-'.$category->visible.' ">'.format_text($category->name, FORMAT_HTML).'</a>
