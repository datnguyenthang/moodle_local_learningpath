...
use local_learningpath\utility;
use local_learningpath\catalogue_utility;
/**
 * Defines the learning path form.
 */
class line_form extends dynamic_form {
    ...
    public function definition() {
        ...
        $coursecategories = utility::get_categories_list();
        $cataloguecategories = catalogue_utility::get_catalogue_categories_list();

        $coursecategoryfilterhtml = utility::generateCategoryStructure($coursecategories);
        $cataloguecategoryfilterhtml = catalogue_utility::generateCategoryStructure($cataloguecategories);

        $mform->addElement('html', $OUTPUT->render_from_template('local_learningpath/modal/line', [
            'lpt_id' => $data['lpt_id'],
            'coursecategoryfilterhtml' => $coursecategoryfilterhtml,
            'cataloguecategoryfilterhtml' => $cataloguecategoryfilterhtml,
        ]));
